...
<div class="about">
    ...
    <ol>
        <li>
            <h3><a href="games.php">Empires</a></h3>
            <p>A strategy game where you build and expand your own empire.</p>
        </li>
        <li>
            <h3><a href="games.php">Salad Bowl</a></h3>
            <p>A word-guessing game where players try to describe a word without using that word plus other exiting levels</p>
        </li>
    </ol>
</div>
